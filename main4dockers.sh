...
echo "33333333333333333"
 /homes/aa23916/ToRunDacapo/DockerTemp_ParallelDockersV2/main_rundocker3.sh $testname $3 &
echo "4444444444444444"
 /homes/aa23916/ToRunDacapo/DockerTemp_ParallelDockersV2/main_rundocker4.sh $testname $4 &
